    ...
    <div className="min-h-screen bg-[#D9E1E8] px-4 py-12 sm:py-16">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm p-8 sm:p-12">
        ...
        <div className="space-y-5 text-[#2F3E4E] text-[15px] leading-relaxed">
          <p>
            Coming Homecare was created and is operated by a Registered Nurse with a lifelong interest in
            science, the human body, education, and finding practical ways to help people live healthier,
            happier, and more manageable lives.
          </p>
          ...
          <p>
            ...
            homes, our friendships, and our personal relationships.
          </p>
          <p>
            We become accustomed to anticipating other people&rsquo;s needs, solving problems, keeping things
            organized, and helping others heal. Too often, we hesitate to ask for help ourselves&mdash;or become
            so focused on caring for everyone else that we forget to care for the person in the mirror.
            Eventually, an empty cup can lead to exhaustion, frustration, burnout, and the painful feeling of
            being forgotten&mdash;even by ourselves.
          </p>
          ...
          <p>
            Our goal is to simplify repetitive tasks, organize important information, streamline everyday
            processes, and automate what can be automated&mdash;while maintaining affordability, privacy, and
            respect for the people relying on these services.
          </p>
          <p>
            Technology should not make care feel colder or more complicated. It should quietly work in the
          ...
          <p>
            Every process we simplify is time returned to someone&mdash;a quiet evening, a moment to rest, a
            conversation with a loved one, or simply the opportunity to breathe.
          </p>
