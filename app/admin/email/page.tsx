              ...
              <div className="p-4 space-y-3">
                ...
                {previewTemplate && (
                  <p className="text-[11px] text-[#7A8F79]">
                    Preview sends to your admin email with sample data.
                  </p>
                )}
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="grid md:grid-cols-[240px_1fr] divide-y md:divide-y-0 md:divide-x divide-[#D9E1E8]">
                  ...
                  <div className="p-5 flex flex-col gap-3">
                    ...
                    {recipientCount > 0 && (
                      <p className="text-xs text-[#7A8F79]">{recipientCount} recipient{recipientCount !== 1 ? 's' : ''} selected</p>
                    )}
                  </div>
                  ...
                  <div className="p-5 flex flex-col gap-4">
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <textarea value={body} onChange={e => setBody(e.target.value)} rows={9} placeholder="Write your message here…" className="w-full flex-1 border border-[#D9E1E8] rounded-lg px-3 py-2 text-sm text-[#2F3E4E] focus:outline-none focus:ring-2 focus:ring-[#7A8F79] resize-none" />
                    ...
                    <button type="submit" disabled={sending || recipientCount === 0} className="w-full bg-[#2F3E4E] text-white font-semibold py-2.5 rounded-xl hover:bg-[#7A8F79] transition disabled:opacity-50 text-sm">
