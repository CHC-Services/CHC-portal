...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (body.patientCtrlNum !== undefined) data.patientCtrlNum = body.patientCtrlNum.trim()
  ...
  if (body.paidAmount     !== undefined) data.paidAmount     = body.paidAmount != null ? parseFloat(body.paidAmount) : null
