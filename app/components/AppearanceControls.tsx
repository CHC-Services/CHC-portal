...
// Visual customization controls — shared between admin's system/appearance page
// and the family myProfile Settings tab. Reads/writes the same localStorage-backed
// lib/portalSettings.ts settings that PortalSettingsProvider applies globally.
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <p className="text-sm font-bold text-[#2F3E4E]">Visual Customization</p>
      ...
      <div className="bg-white rounded-xl shadow-sm p-5">
        ...
        <div className="flex gap-3 flex-wrap">
          {GUTTER_COLORS.map(c => (
            <button
              key={c.value}
              onClick={() => update('gutterColor', c.value)}
              title={c.label}
