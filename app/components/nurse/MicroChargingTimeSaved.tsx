...
// at least one voice entry) divided by a standard 40 WPM typing pace. Meant
// to sit next to MicroChargingDevices.tsx so the payoff of setting a device
// up is visible in the same glance, and so it's easy to find again later
// (e.g. checking back mid free-trial to see the value add for herself).
