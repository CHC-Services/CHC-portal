                  ...
                  <div className="bg-[#f4f6f8] rounded-xl p-4">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <a
                        ...
                        className="flex items-center gap-2 bg-white border border-[#D9E1E8] hover:border-[#3D95CE] hover:bg-[#f0f8ff] text-[#2F3E4E] font-semibold text-sm px-4 py-2.5 rounded-xl transition shadow-sm"
                        title={`Pay via Venmo · @AlexMcGann`}
                      >
                        <svg viewBox="0 0 24 24" className="w-5 h-5 flex-shrink-0" style={{ fill: '#3D95CE' }} xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 bg-white border border-[#D9E1E8] hover:border-[#00D632] hover:bg-[#f0fff4] text-[#2F3E4E] font-semibold text-sm px-4 py-2.5 rounded-xl transition shadow-sm"
                        title={`Pay via Cash App · $myInvoiceCHC`}
                      >
                        <svg viewBox="0 0 24 24" className="w-5 h-5 flex-shrink-0" style={{ fill: '#00C244' }} xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 bg-white border border-[#D9E1E8] hover:border-[#555] hover:bg-[#f8f8f8] text-[#2F3E4E] font-semibold text-sm px-4 py-2.5 rounded-xl transition shadow-sm"
                        title="Pay via Apple Cash"
                      >
                        <svg viewBox="0 0 24 24" className="w-5 h-5 flex-shrink-0 fill-black" xmlns="http://www.w3.org/2000/svg">
